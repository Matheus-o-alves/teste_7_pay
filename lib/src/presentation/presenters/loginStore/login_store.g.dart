...
mixin _$LoginStore on _LoginStore, Store {
  ...
  late final _$showUsernameErrorAtom =
      Atom(name: '_LoginStore.showUsernameError', context: context);

  @override
  bool get showUsernameError {
    _$showUsernameErrorAtom.reportRead();
    return super.showUsernameError;
  }

  @override
  set showUsernameError(bool value) {
    _$showUsernameErrorAtom.reportWrite(value, super.showUsernameError, () {
      super.showUsernameError = value;
    });
  }

  late final _$showPasswordErrorAtom =
      Atom(name: '_LoginStore.showPasswordError', context: context);
